...
# Ключи: "BASIC" и "PREMIUM" (зашифрованы в base64)
ENCRYPTED_BASIC = "QkFTSUMyMDI1"      # "BASIC2025" (старый, оставлен для совместимости)
ENCRYPTED_PREMIUM = "UFJFTUlVTjIwMjU=" # "PREMIUM2025" (старый)
# Новые ключи для "BASIC" и "PREMIUM"
ENCRYPTED_BASIC_NEW = "QkFTSUMMTg=="   # "BASIC" (новый)
ENCRYPTED_PREMIUM_NEW = "UFJFTUlVTQ==" # "PREMIUM" (новый)

def decrypt_key(encrypted):
    return base64.b64decode(encrypted).decode('utf-8')

# Используем новые ключи
BASIC_KEY = decrypt_key(ENCRYPTED_BASIC_NEW)      # "BASIC"
PREMIUM_KEY = decrypt_key(ENCRYPTED_PREMIUM_NEW)  # "PREMIUM"
...
def key_screen():
    ...
    lines.append(f"{RED_DIM}   BASIC или PREMIUM{RESET}")
    for line in lines:
